...
public:
	...
	Device(DeviceIO IO, DeviceType type, int deviceId, int radioId = 0, const char *name = {0}, int size = 0, NewValueFunction dataFromRadio = NULL) : IO(IO), type(type), deviceId(deviceId), radioId(radioId), name(name), size(DeviceValueMinSize(type, size))
	{
